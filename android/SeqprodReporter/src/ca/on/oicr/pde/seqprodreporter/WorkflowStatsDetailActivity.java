...
/**
 * An activity representing a single WorkflowStats detail screen. This activity
 * is only used on handset devices. On tablet-size devices, item details are
 * presented side-by-side with a list of items in a
 * {@link WorkflowStatsListActivity}.
 * <p>
...
public class WorkflowStatsDetailActivity extends FragmentActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_workflowstats_detail);
		...
		if (savedInstanceState == null) {
			...
			getSupportFragmentManager().beginTransaction()
					.add(R.id.workflowstats_detail_container, fragment)
					.commit();
		}
	}
